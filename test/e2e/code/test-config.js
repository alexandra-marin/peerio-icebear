...
module.exports = {
    ...
    primaryEmailConfirmSubject:
        'Welcome to Peerio (Staging)! Confirm your account.',
    ...
    inviteEmailSubject:
        'Firstname Lastname has invited you to Peerio (Staging)!',
    // email subject when receiving a MC doctor email invitation to join from a MC admin/doctor
    inviteEmailSubjectMCDoctor:
        'Firstname Lastname has invited you to Medcryptor!',
    // email subject when receiving a Peerio email invitation to join from an MC user
    inviteEmailSubjectMCPatient:
        'Your doctor wants to connect with you on Peerio',
