Feature: Sharing files in DM
    ...
    Scenario: Unshare in DM
        ...
        Then  The uploaded file is shared with Cucumbot
        And   Cucumbot received the uploaded file in DM
        And   I unshare the uploaded file with Cucumbot
        And   The uploaded file is removed from the DM
    ...
    Scenario: Share in room
        ...
        And   Cucumbot received the uploaded file in the room
        And   Cucumbot can download the received file in the room
        And   Cucumbot has 0 files in his drive
        When  Cucumbot restarts
        Then  Cucumbot received the uploaded file in the room
        And   Cucumbot has 0 files in his drive
